    ...
    switch (_type)
    {
      case CIRCULO:
        for (int i = 0; i < 150; i++){
          ...
          v.x = 60*v.x*cos(angulo);
          v.y = 60*v.y*sin(angulo);
      ...
      case CORAZON:
        for (int i = 0; i < 150; i++){
          ...
          v.x = -120*(3*sin(angulo)-1*sin(3*angulo));
          v.y = -120*(3.25*cos(angulo)-1.25*cos(2*angulo)-0.5*cos(3*angulo)-0.25*cos(4*angulo));
